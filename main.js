...
// function saoEstritamenteIguais(a, b) {
//   return a === b;
// }

// // Testes:
// console.log(saoEstritamenteIguais(5, 5));       // true (mesmo valor e tipo)
// console.log(saoEstritamenteIguais(5, "5"));     // false (mesmo valor, tipos diferentes)
// console.log(saoEstritamenteIguais("a", "a"));   // true (mesmo valor e tipo)
// console.log(saoEstritamenteIguais(true, 1));     // false (tipos diferentes)
...
// // Testes:
// verificarNome("");     // Exibe: "Nome vazio"
// verificarNome(" ");    // Exibe: "Nome preenchido"
// verificarNome("Ana");  // Exibe: "Nome preenchido"
...
let media = 7.5;
let statusSimples = media >= 7 ? "Aprovado" : "Reprovado";
console.log(`Resultado: ${statusSimples}`);